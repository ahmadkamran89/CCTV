...
<div class="max-w-4xl mx-auto mb-12">
    ...
    <div class="flex items-center gap-4 mb-10">
        ...
        <div>
            <h1 class="font-headline font-bold text-3xl text-gray-900 tracking-tight">Create Category</h1>
            <nav class="flex text-sm font-medium text-gray-400 gap-2 mt-1">
                <span>Admin</span>
                <span>•</span>
                <span>Categories</span>
                <span>•</span>
                <span class="text-primary">New Category</span>
            </nav>
        </div>
    </div>
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-8">
        ...
        <div class="bg-white rounded-[2.5rem] p-10 border border-gray-100 shadow-xl shadow-gray-200/40">
            <div class="grid md:grid-cols-2 gap-x-10 gap-y-8">
                ...
                <div>
                    <label for="slug" class="block text-sm font-bold text-gray-700 mb-2 tracking-tight">URL Slug <span class="text-gray-400 font-normal">(Optional)</span></label>
                ...
                <div>
                    ...
                    <input type="text" id="icon" name="icon" value="{{ old('icon', 'category') }}"
                           class="w-full px-5 py-4 rounded-2xl border border-gray-100 bg-gray-50/50 
                                  focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary focus:bg-white
                                  transition-all duration-200 text-base font-medium"
                ...
                <div class="col-span-2">
                    ...
                    <textarea id="description" name="description" rows="3"
                              ...
                              placeholder="Brief description of this category for the home page...">{{ old('description') }}</textarea>
                </div>
